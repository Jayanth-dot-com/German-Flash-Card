...
white_square = PhotoImage(file="card_front.png")
green_square = PhotoImage(file="card_back.png")
correct_button = PhotoImage(file="right.png")
incorrect_button = PhotoImage(file="wrong.png")
